...
class BankProductTest {
    ...
    @Test
    void isOwnedBy() {
        AccountHolder primaryOwner = new AccountHolder("primaryOwner", "BankProductTestHolder1","Password", LocalDate.now(), new Address());
        ...
        AccountHolder secondaryOwner = new AccountHolder("secondaryOwner", "BankProductTestHolder2","Password", LocalDate.now(), new Address());
        ...
        AccountHolder nonOwner = new AccountHolder("nonOwner", "BankProductTestHolder3", "Password", LocalDate.now(), new Address());
        nonOwner.setId(3);
