...
public class CreditCardController {
    ...
    public CreditCard saveCreditCards(@RequestBody @Valid CreateBankProductDao<CreditCard> card) {
        return this.creditCardService.createNewProduct(card);
    }

    @PutMapping("/card/")
    @ResponseStatus(HttpStatus.CREATED)
    public CreditCard updateCreditCards(@RequestBody @Valid CreditCard card) {
