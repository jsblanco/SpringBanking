...
public class StudentCheckingAccountController {
    ...
    public StudentCheckingAccount saveStudentCheckingAccounts(@RequestBody StudentCheckingAccount account) {
        return this.studentCheckingAccountService.save(account);
    }

    @PutMapping("/student/")
    @ResponseStatus(HttpStatus.CREATED)
    public StudentCheckingAccount updateStudentCheckingAccounts(@RequestBody StudentCheckingAccount account) {
        return this.studentCheckingAccountService.update(account);
    }

    @DeleteMapping("/student/")
    @ResponseStatus(HttpStatus.OK)
    public void deleteStudentCheckingAccounts(@RequestBody StudentCheckingAccount account) {
        this.studentCheckingAccountService.delete(account);
    }
}
